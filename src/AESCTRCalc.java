...
public class AESCTRCalc extends JPanel{
	/**
	 * 
	 */
    ...
    private AESCTRCalc(){
        ...
        inputButton.addActionListener(e -> {
            ...
            fc.setFileFilter((javax.swing.filechooser.FileFilter) inputFilter);
            int returnVal = fc.showOpenDialog(AESCTRCalc.this);
        ...
        keyButton.addActionListener(e -> {
            ...
            if (finalIsUnlimitedSupported) {
                fc.setFileFilter((javax.swing.filechooser.FileFilter) unlimitedKeyFilter);
            } else {
                fc.setFileFilter((javax.swing.filechooser.FileFilter) limitedKeyFilter);
            }
            
            int returnVal = fc.showDialog(AESCTRCalc.this, "a");
    ...
    public static void main(String[] args) {
        ...
        frame.setContentPane(new AESCTRCalc().panel1);
